                    ...
                    <asp:UpdatePanel ID="UpdatePanelUser" runat="server">
                        <ContentTemplate>
                            <asp:ListView ID="UserListView" runat="server" 
                                ...
                                ItemType="eBike.Data.Entities.Security.UserProfile"
                                DataKeyNames="UserId"
                        ...
                        <asp:ObjectDataSource ID="UserListViewODS" runat="server" 
                            ...
                            TypeName="eBikeSystem.BLL.Security.UserManager"
                            ...
                            OldValuesParameterFormatString="original_{0}"  
                            TypeName="eBikeSystem.BLL.Security.RoleManager">
                        </asp:ObjectDataSource>
                        </ContentTemplate>
                    </asp:UpdatePanel>   
                </div>
                    ...
                    <asp:UpdatePanel ID="UpdatePanelrole" runat="server">
                        <ContentTemplate>
                           <asp:ListView ID="RoleListView" runat="server"
                               ...
                               InsertItemPosition="LastItem"
                               DataKeyNames="RoleID"
                               ItemType="eBike.Data.Entities.Security.RoleProfile"
                               OnItemDeleted="RefreshAll"
                               OnItemInserted="RefreshAll"
                               >
                               <EditItemTemplate>
